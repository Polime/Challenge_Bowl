      ...
      <section id="content">
        <div style="margin-left: 20px;margin-top: 10px">
         <?php
              ...
              $sql = "select * from doc_info where name = '$old_name'";
              $res = $pdo->query($sql);
              foreach($res as $row){
                $name =  $row['user'];
              }
            ?>
          <a href="http://simplewebrtc.com/demo.html?<?php echo $name; ?>" class="btn btn-xs btn-success m-t-xs" style="width: 100px;height: 40px;font-size: 20px;">加入视频
        </a>
        </div>
