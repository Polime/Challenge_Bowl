        ...
        <section class="vbox">
          <section class="w-f scrollable">
            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
              <nav class="nav-primary hidden-xs">
                <ul class="nav">
                  <li class="active"> <a href="man_home.php" >  <i class="fa fa-envelope-o icon"> <b class="bg-primary dker"></b> </i> <span>数据分析</span> </a> </li>
...
>>>>>>> 136ccb4557850fc96eff49d98e6bcd4907cec835
