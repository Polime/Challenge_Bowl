      ...
      <section id="content">
        <section class="vbox">
          <header class="header bg-white b-b b-light">
            <p>  <strong>老人档案</strong></p>
          </header>
          <section class="scrollable wrapper">
            <div name="new_old">
              <h4>新增老人</h4>
              <?php require "back_end/doc_new_old.php"; ?>
            </div>
            <hr>
            <div name="old_info">
              <h4>老人信息</h1>
              <?php require "back_end/doc_info_old.php"; ?>
            </div>
            <hr>
            <div name="old">
              <h4>家属信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;病例信息</h4>
              <form method="post" action="doc_relative_case_old.php">
                <select name="old_name">
                  <option></option>
                  <?php 
                    $op = "select name,id from old_info";
                    $re = $pdo->query($op);
                    foreach ($re as $ro) {
                      $name = $row['name'];
                  ?>
                ...
                <input type="text" name="old_id" placeholder="老人身份证">
